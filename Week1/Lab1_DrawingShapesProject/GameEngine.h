...
//
// First year engine: 
//		- developed from GameEngine 7_02
//		- some features left out to keep things simple for the first year:
//			- wide character text (in the GameEngine interface)
//			- draw functions that draw to device contexts other than computer screen
//			- draw functions don't use default arguments, but are overloaded where applicable (for clarity)
//
//-----------------------------------------------------------------
