...
void Draw()
{
	...
	// Crab draw
	Rectf crabSourceRect{
	(g_CrabSpriteData.currentFrame / g_CrabSpriteData.rows) * g_CrabSpriteData.frameHeight,
	(g_CrabSpriteData.currentFrame % g_CrabSpriteData.columns) * g_CrabSpriteData.frameWidth,
	...
	const Rectf girlSourceRect{
		(g_GirlSpriteData.currentFrame / g_GirlSpriteData.rows) * g_GirlSpriteData.frameHeight ,
		(g_GirlSpriteData.currentFrame % g_GirlSpriteData.columns) * g_GirlSpriteData.frameWidth,
